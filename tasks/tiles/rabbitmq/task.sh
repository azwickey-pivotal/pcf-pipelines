...
product_properties=$(
  jq -n \
    ...
    '
    {
      ...
      ".properties.on_demand_broker_plan_1_selector.enabled.cf_service_access": { "value": [ "enable" ] },
      ...
      ".properties.on_demand_broker_plan_6_selector.enabled.cf_service_access": { "value": [ "enable" ] },
